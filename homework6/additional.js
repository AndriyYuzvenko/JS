...
// ];
//
// let coursesArrayNew = (item) => {
//     return item.sort((a, b) => b.modules.length - a.modules.length)
// }
// console.log(coursesArrayNew(coursesArray));
//
//
// відсортувати його в спадаючому порядку за кількістю елементів в полі modul/es
